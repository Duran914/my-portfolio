<?php include "inc/header.php"?>
        ...
        <div class="container" id="aboutContainer">
          ...
          <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                 <div class="section-header abou mt-5 mb-4">EDUCATION</div>
                 </div>
              </div>
        ...
        <div class="container" id="aboutContainer">
          ...
          <div class="row">
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                 <div class="section-header about mt-5 mb-5">EXPERIENCE</div>
                 </div>
              </div>
        ...
        <section class="tech-stack">
          <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
              <div class="section-header techLabel mt-5 mb-5">TECHNOLOGIES I USE</div>
              <div class="card main-card">
        ...
        <div class="container">
          ...
          <div class="container">
              ...
              <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                  <div class="section-header mb-5 mt-5">CONNECT WITH ME</div>
                </div>
              </div>
              <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div class="contact-social">
                  <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-5">
                      <a class="contactSocialLink" target="_blank" href="https://github.com/Duran914">
                        <div class="card main-card">
                          <div class="card-body">
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-5">
                      <a class="contactSocialLink" target="_blank" href="https://www.linkedin.com/in/johnny-duran/">
                        <div class="card main-card">
                          <div class="card-body">
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4 mb-5">
                        <a class="contactSocialLink" href="mailto:johny914@gmail.com">
                          <div class="card main-card">
                            <div class="card-body">
                              <i class="fa fa-envelope fa-4x" aria-hidden="true"></i>
                              <br>
                              <span>
                                <h4 class="conntectSocialText">E-Mail</h4>
                              </span>
                            </div>
                          </div>
                        </a>
